...
const OrganizationInterviews: React.FC = () => {
  ...
  const fetchInterviews = async () => {
    try {
      setLoading(true);
      console.log('🔍 Fetching organization applications for interviews...');
      
      const response = await apiService.getOrganizationApplications();
      console.log('📊 Organization Applications Response:', response);
      ...
      if (response.status === 'success') {
        ...
        console.log('🎯 Final Organization Interviews:', interviewsWithData.length, interviewsWithData);
      ...
      console.error('💥 Failed to fetch organization interviews:', error);
      toast({
        title: "Error",
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-sm text-muted-foreground">
          Schedule interviews from the Applications tab to see them here.
        </p>
      </div>
    );
  }
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  <CardTitle className="text-lg flex items-center gap-2">
                    ...
                    {interview.personalInfo.firstName} {interview.personalInfo.lastName}
                  </CardTitle>
                  <CardDescription className="text-base">
                    {interview.opportunity.title}
                  </CardDescription>
                  <p className="text-sm text-muted-foreground">
                    {interview.personalInfo.email}
                  </p>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    // TODO: Add functionality to update interview status
                    toast({
                      title: "Feature Coming Soon",
                      description: "Interview status updates will be available soon",
                    });
                  }}
                >
                  Mark Complete
